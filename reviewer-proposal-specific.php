<?php
	...
	echo "<input type=\"image\" src=\"img/back.png\" onclick=\"return 		
									  false\" ";
	if($viewtype == 'reviewed')								  
		echo "onmousedown=\"javascript:swapReviewedContent('$back_to');\"/>";
	else if($viewtype == 'pending')	
		echo "onmousedown=\"javascript:swapContent('$viewtype');\"/>";
	else if($viewtype == 'others')
		echo "onmousedown=\"javascript:swapGeneralViewContent('$back_to');\"/>";
