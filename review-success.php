...
<ul id="css3menu1" class="topmenu">
    <li ><a href="#"  onclick= "return false" onmousedown="javascript:swapContent('reviewed');" style="height:14px;line-height:14px;">Reviewed Proposals</a></li>
    <li ><a href="#" onclick= "return false" onmousedown="javascript:swapContent('pending');" style="height:14px;line-height:14px;">Pending Proposals</a></li>
...
<div id = "container" style="width:1150px">
    <p><h1><img src="img/success.png" alt="Submitted review successfully!"/></h1></p>
    <p><a href="index-reviewer.php">Back to Home</p>
</div> <!--container-->
