...
<div id = "container" style="width:1150px">
	...
	<div id="sidebar">
     <label><h2><em>&nbsp;My Proposals</em></h2></label>
     	<ul class="sidebar">
			
		
		<li><a href="#" onclick="return false" onmousedown="javascript:swapMyViewContent('all');">All</a></li>
		
		<li><a href="#" onclick="return false" onmousedown="javascript:swapMyViewContent('approved');">Approved</a></li>
		
		<li><a href="#" onclick="return false" onmousedown="javascript:swapMyViewContent('disapproved');">Disapproved</a></li>
		
		<li><a href="#" onclick="return false" onmousedown="javascript:swapMyViewContent('under_review');">Under Review</a></li>
   ...
   <div id="view">
        <blockquote><small>View your proposals by clicking on the menu on the left.</small></blockquote> 
   </div> <!--END OF view ID-->	
